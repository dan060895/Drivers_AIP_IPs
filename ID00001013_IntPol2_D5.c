#include "ID00001013_INTPOL2_D5.h"
...
int32_t ID00001013_init(uint32_t address, uint32_t port)
{
    ...
    dev_dbg("IP_INTPOL2_D5","INIT: ID READ : %08X\n", id);    
...
{
    dev_dbg("IP_INTPOL2_D5","========== START IP INTPOL2_D5 SUCCESSFULLY ==========\n");
...
int32_t ID00001013_IntPol2_D5_setConf(uint32_t address, uint32_t port, GRVGC_state *GRVGC_currentState)
{
/*
